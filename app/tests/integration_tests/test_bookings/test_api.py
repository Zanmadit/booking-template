...
@pytest.mark.parametrize("room_id,date_from,date_to,booked_rooms,status_code", [
    (2, "2030-05-01", "2030-05-15", 2, 200),
    (2, "2030-05-01", "2030-05-15", 3, 200),
    (2, "2030-05-01", "2030-05-15", 4, 200),
    (2, "2030-05-01", "2030-05-15", 5, 200),
    (2, "2030-05-01", "2030-05-15", 5, 409),  # после 5 бронирований — ошибка
])
